          ...
          {slides.map((slide, i) => (
            ...
            >
              ...
              <div className="carousel-caption glass-box">
                <h2 className="carousel-title animate-hero-title">
                  {slide.label}
                </h2>
                <p className="carousel-desc animate-hero-text">{slide.desc}</p>
              </div>
            </div>
          ))}
        </div>

        {/* Controls – Bootstrap default */}
        <button
